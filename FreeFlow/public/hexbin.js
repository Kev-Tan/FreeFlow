  ...
  (function () {
    d3.hexbin = function () {
      ...
      hexbin.centers = function () {
        var centers = [];
        for (
          var y = 0, odd = false, j = 0;
          y < height + r;
          y += dy, odd = !odd, ++j
        ) {
          for (
            var x = odd ? dx / 2 : 0, i = 0;
            x < width + dx / 2;
            x += dx, ++i
          ) {
            var center = [x, y];
...
/*
     FILE ARCHIVED ON 10:27:34 Mar 10, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:43:15 Aug 22, 2025.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 178.819 (4)
  load_resource: 143.403
  PetaboxLoader3.resolve: 113.262
*/
