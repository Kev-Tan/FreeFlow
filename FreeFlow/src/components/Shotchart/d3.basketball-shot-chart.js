...
(function () {
  ...
  var BasketballShotChart = d3.chart("BasketballShotChart", {
    ...
    drawLegend: function () {
      ...
      var largestHexagonRadius =
        hexagonRadiusSizes[hexagonRadiusSizes.length - 1];
      var colorXMid =
        courtWidth -
      ...
      var colorLegend = this.base.append("g").classed("legend", true);
      colorLegend
        .append("text")
      ...
      var sizeLegend = this.base.append("g").classed("legend", true);
      sizeLegend
        .append("text")
        .classed("legend-title", true)
        .attr("x", sizeXMid)
      ...
      sizeLegend
        ...
        .attr("transform", function (d, i) {
          sizeXStart += d * 2;
          return "translate(" + (sizeXStart - d) + ", " + sizeYStart + ")";
        })
        .style("fill", "#999");
      sizeLegend
        .append("text")
    ...
    drawShots: function () {
      ...
      this.layer("hexagons", layerBase, {
        ...
        insert: function () {
          return this.append("path").classed("shot-chart-hexagon", true);
        },
    ...
    calculateVisibleCourtLength: function () {
      ...
      var threePointLength =
        this._threePointRadius + this._basketProtrusionLength;
      this._visibleCourtLength =
